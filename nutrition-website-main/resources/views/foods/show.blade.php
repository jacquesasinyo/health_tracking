...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 mb-4">
                <div class="card h-100 shadow-sm">
                    @if($food->photo)
                        <img src="{{ asset($food->photo) }}" alt="{{ $food->description }}" class="card-img-top" style="height: 180px; object-fit: cover; border-radius: 0.5rem 0.5rem 0 0;">
                    @else
                    ...
                    <div class="card-body text-center">
                        <h1 class="card-title h5 mb-2 text-primary">{{ $food->description ?? $food->turkish_description }}</h1>
                            ...
                            <div class="col-md-5 d-flex justify-content-center align-items-center mb-3">
                                <div style="position: relative; width: 150px; height: 150px;">
                                    ...
                                    <div id="calorieLabel"
                                        ...
                                        {{ $energyValue }}<br><small style="font-size: 11px;">kcal</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-7">
                                    ...
                                    <div class="mb-2 p-2 bg-light rounded">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <h6 class="mb-0 small" id="carbValue" data-original="{{ $nutrients->firstWhere('nutrient_name', 'Carbohydrate, by difference')->amount ?? 0 }}">
                                                    {{ $nutrients->firstWhere('nutrient_name', 'Carbohydrate, by difference')->amount ?? 0 }} g
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-2 p-2 bg-light rounded">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <h6 class="mb-0 small" id="proteinValue" data-original="{{ $nutrients->firstWhere('nutrient_name', 'Protein')->amount ?? 0 }}">
                                                    {{ $nutrients->firstWhere('nutrient_name', 'Protein')->amount ?? 0 }} g
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="p-2 bg-light rounded">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <h6 class="mb-0 small" id="fatValue" data-original="{{ $nutrients->firstWhere('nutrient_name', 'Total lipid (fat)')->amount ?? 0 }}">
                                                    {{ $nutrients->firstWhere('nutrient_name', 'Total lipid (fat)')->amount ?? 0 }} g
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        @foreach($nutrients as $nutrient)
                            <tr>
                                <td><strong>{{ $nutrient->nutrient_name }}</strong> <small class="text-muted">({{ $nutrient->unit_name }})</small></td>
                                <td class="text-center">{{ $nutrient->amount }}</td>
                                <td class="nutrient-value fw-bold text-center text-primary" data-amount="{{ $nutrient->amount }}" data-original="{{ $nutrient->amount }}">
                                    {{ $nutrient->amount }}
                                </td>
                            </tr>
                        @endforeach
        ...
        <div class="mt-4 mb-5 text-center">
            <a href="{{ route('food.index') }}" class="btn btn-outline-primary btn-lg">
