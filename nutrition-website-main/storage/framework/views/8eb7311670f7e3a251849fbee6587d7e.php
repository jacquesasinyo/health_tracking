...
<head>
    ...
    <title><?php echo e(config('app.name', 'Health Tracker')); ?></title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('muscles.index')); ?>">
...
<?php /**PATH /Volumes/WD Elements/web projects/health/nutrition-website-main/resources/views/layouts/app.blade.php ENDPATH**/ ?>