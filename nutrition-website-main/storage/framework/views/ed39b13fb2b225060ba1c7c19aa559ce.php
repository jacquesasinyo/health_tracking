...
<div class="container-fluid px-4">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('muscles.index')); ?>">Workouts</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?php echo e(ucfirst($muscle)); ?></li>
                </ol>
            </nav>
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h1 class="mb-0"><?php echo e(ucfirst($muscle)); ?> Training</h1>
                    <p class="text-muted mb-0">Explore exercises and stretches for your <?php echo e($muscle); ?>.</p>
                </div>
            </div>
        </div>
    </div>

    <?php if($exercises->count() > 0): ?>
        <div class="row">
            <div class="col-12">
                <h2 class="mb-4">
                    ...
                    <?php $__currentLoopData = $exercises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exercise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-12 mb-4">
                            <div class="card h-100 shadow-sm">
                                <div class="card-body">
                                    <h5 class="card-title text-primary"><?php echo e($exercise->name); ?></h5>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="exercise-gif-container">
                                                <?php if($exercise->image): ?>
                                                    <img src="<?php echo e(asset($exercise->image)); ?>" class="img-fluid rounded" alt="<?php echo e($exercise->name); ?>">
                                                <?php else: ?>
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <div class="mt-4">
                                                <span class="badge bg-primary me-2">
                                                    <i class="fas fa-signal me-1"></i><?php echo e(ucfirst($exercise->difficulty)); ?>

                                                </span>
                                                <?php if($exercise->equipment): ?>
                                                    <span class="badge bg-secondary">
                                                        <i class="fas fa-tools me-1"></i><?php echo e(ucfirst($exercise->equipment)); ?>
    ...
    <?php if($stretches->count() > 0): ?>
        <div class="row mt-4">
            <div class="col-12">
                ...
                <div class="row">
                    <?php $__currentLoopData = $stretches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stretch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-12 mb-4">
                            <div class="card h-100 shadow-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-md-4">
                                            <?php if($stretch->image): ?>
                                                <div class="exercise-gif-container">
                                                    <img src="<?php echo e(asset($stretch->image)); ?>" class="img-fluid rounded" alt="<?php echo e($stretch->name); ?>">
                                                </div>
                                            <?php else: ?>
                                        ...
                                        <div class="col-md-8">
                                            <h5 class="card-title text-warning"><?php echo e($stretch->name); ?></h5>
                                            ...
                                            <div class="mt-3">
                                                <span class="badge bg-info me-2">
                                                    <i class="fas fa-clock me-1"></i><?php echo e($stretch->duration); ?>

                                                </span>
                                                <span class="badge bg-success">
                                                    <i class="fas fa-signal me-1"></i><?php echo e(ucfirst($stretch->difficulty)); ?>
    ...
    <?php if($exercises->count() === 0 && $stretches->count() === 0): ?>
        <div class="row">
            <div class="col-12">
                <div class="card bg-light">
                    <div class="card-body text-center py-5">
                        ...
                        <a href="<?php echo e(route('muscles.index')); ?>" class="btn btn-primary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/WD Elements/web projects/health/nutrition-website-main/resources/views/muscles/show.blade.php ENDPATH**/ ?>