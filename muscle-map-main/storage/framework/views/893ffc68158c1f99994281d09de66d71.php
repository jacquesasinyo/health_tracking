<?php $__env->startSection('title', 'MuscleMap - ' . ucfirst($muscle)); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-4">
        <div class="row">
            <div class="col-12">
                <h1 class="mt-4"><?php echo e(ucfirst($muscle)); ?> Exercises</h1>
                <p>Explore exercises and stretches for your <?php echo e($muscle); ?>.</p>
            </div>
        </div>
                    ...
                    <?php $__currentLoopData = $exercises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exercise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-12 mb-4">
                            <div class="card h-100">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo e($exercise->name); ?></h5>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="exercise-gif-container">
                                                <img src="<?php echo e(asset($exercise->image)); ?>" class="img-fluid" alt="<?php echo e($exercise->name); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            ...
                                            <div class="mt-4">
                                                <span class="badge bg-primary me-2"><?php echo e(ucfirst($exercise->difficulty)); ?></span>
                                                <?php if($exercise->equipment): ?>
                                                    <span class="badge bg-secondary"><?php echo e(ucfirst($exercise->equipment)); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card h-100">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-8">
                                                <h5 class="card-title"><?php echo e($stretch->name); ?></h5>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/jacques/Desktop/muscle-map-main/resources/views/pages/muscle.blade.php ENDPATH**/ ?>