...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'MuscleMap'); ?></title>
    <!-- Favicon-->
    ...
    <script src="<?php echo e(asset('js/jquery.imagemapster.js')); ?>"></script>
...
<div class="d-flex sticky-top" id="wrapper">
    ...
    <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark position-fixed col-3 px-1 bg-dark position-fixed">
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100 nav flex-column flex-nowrap vh-100 overflow-auto text-white p-2">
            <a href="<?php echo e(route('home')); ?>" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
...
<?php /**PATH /Users/jacques/Desktop/muscle-map-main/resources/views/layouts/app.blade.php ENDPATH**/ ?>